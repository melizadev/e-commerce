  ...
  return (
    <div className='bg-white container px-2 flex-row mt-8 md:flex-row lg:flex-row flex lg:justify-between pb-2 mb-15'>
      <div className='w-full flex flex-col'>
        <div>
          <h1 className='text-2xl text-[#4a5565] font-bold'>{t('filter.articles')}</h1>
            ...
            ? (
                filteredProducts.map(product => (
                  <div key={product.id} className='flex flex-col justify-between items-start bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300'>
                    <img src={product.image} alt='' className='lg:h-[300px] md:h-[250px] h-[290px] cursor-pointer w-full object-cover' />
